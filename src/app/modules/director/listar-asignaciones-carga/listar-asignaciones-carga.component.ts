// listar-asignaciones-carga.component.ts - VERSIÓN SIMPLIFICADA
...
export class ListarAsignacionesCargaComponent implements OnInit {
  ...
  buscarCursosAgrupados(): void {
    ...
    this.directorService.obtenerCursosAgrupadosPorCarga(
      ...
      error: (err) => {
        console.error('Error cargando cursos agrupados:', err);
        this.cursosAgrupados = [];
        this.loading = false;
